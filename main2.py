				...
				<div class="about-block">
					...
					<div class="about-item">
						...
						<div class="content">
							...
							<p>Our application allows you to crete your own unique designs as well as take inspiration from our extraordinary library of templates curated by professionals</p>
						</div>
					</div>
					<!-- About 02 -->
					<div class="about-item active">
						...
						<div class="content">
							<h5>Easy to Use</h5>
							<p>Our website is extremely user friendly, minimalistic and ease of accesebility are our core principles and we have developed a website based upon core foundation principle</p>
						</div>
					</div>
					<!-- About 03 -->
					<div class="about-item">
						...
						<div class="content">
							<h5>AI tools</h5>
							<p>We provide you with powerful AI tools to enhance your images for personal or proffessional use. </p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title mb-4">
					...
					<p>We offer a range of subscriptions plans, suited for your needs and delivered at affordable prcies</p>
				</div>
			</div>
		</div>
		<div class="row">
...
<div class="pricing-table featured text-center">	
	...
	<!-- Price Tag -->
	<div class="price">	
		<p>Rs.250<span>/month</span></p>
	</div>
	<!-- Features -->
	<ul class="feature-list">
		<li>AI support features</li>
...
<div class="pricing-table text-center">	
	...
	<!-- Price Tag -->
	<div class="price">	
		<p>Rs.500<span>/month</span></p>
	</div>
	<!-- Features -->
	<ul class="feature-list">
		<li>AI support</li>
		<li>One time payment</li>
        <li>Additional support for prifessionals</li>
		<li>Build & Publish</li>
		<li>Life time support</li>
	</ul>
	<!-- Take Action -->
    ...
    <div class="row">
      <div class="col-lg-6 mr-auto">
        <div class="footer-logo">
          <img src="3342176.png" alt="footer-logo">
        </div>
        <div class="copyright">
          <p>Thank you! 
          </p>
